...
def handle_bgmi(message):
    ...
    if user_id in allowed_user_ids:
        ...
        response = "💥 𝘾𝙃𝙐𝙐𝙏𝙄𝙔𝙀𝙀 𝙌 𝙂𝘼𝙉𝘿𝘿 𝙈𝙀 𝙐𝙉𝙂𝙇𝙄𝙄 𝙆𝘼𝙍 𝙍𝘼𝙃𝘼 𝙋𝙀𝙃𝙇𝙀 𝙆𝙃𝘼𝙍𝙄𝘿 𝙏𝙊 𝙇𝙀 @Felixbbyy 𝙋𝘼𝙋𝘼 𝙎𝙀✅"
...
def welcome_start(message):
    ...
    response = f"🙏🏻 𝙒𝙀𝙇𝘾𝙊𝙈𝙀 𝘿𝘼𝙍𝙇𝙄𝙉𝙂 💦 𝘼𝘼 𝙂𝘼𝙔𝘼 𝘽𝙂𝙈𝙄 𝙆𝙄 𝘾𝙃𝙐𝘿𝘼𝙄𝙄 𝙆𝘼𝙍𝙉𝙀 😂💦 𝘾𝙊𝙈𝙈𝘼𝙉𝘿 𝙈𝙀𝙉𝙐 /help. 𝘾𝙃𝙐𝘿𝘼𝙄𝙄 𝙆𝙃𝘼𝙉𝙀 𝙆𝘼 𝘼𝘾𝘾𝙀𝙎𝙎 𝙇𝙀𝙉𝙀 𝙆𝙀 𝙇𝙄𝙔𝙀 𝘿𝙈 ~ @felixbbyy 🌷💥"
    bot.reply_to(message, response)
